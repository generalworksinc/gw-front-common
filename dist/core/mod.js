    ...
    (function(r, i) {
      ...
      return function(h, p, s) {
        var $, d = function(u, f, a) {
          a === void 0 && (a = {});
          var n = new Date(u), l = (function(y, m) {
            m === void 0 && (m = {});
            var _ = m.timeZoneName || "short", v = y + "|" + _, o = i[v];
            return o || (o = new Intl.DateTimeFormat("en-US", { hour12: !1, timeZone: y, year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit", second: "2-digit", timeZoneName: _ }), i[v] = o), o;
          })(f, a);
          return l.formatToParts(n);
        }, b = function(u, f) {
          for (var a = d(u, f), n = [], l = 0; l < a.length; l += 1) {
            var y = a[l], m = y.type, _ = y.value, v = r[m];
        ...
        x.tz = function(u, f) {
          u === void 0 && (u = $);
          var a, n = this.utcOffset(), l = this.toDate(), y = l.toLocaleString("en-US", { timeZone: u }), m = Math.round((l - new Date(y)) / 1e3 / 60), _ = 15 * -Math.round(l.getTimezoneOffset() / 15) - m;
    ...
    (function(r, i) {
      ...
      return function(p, s, $) {
        ...
        d.utcOffset = function(n, l) {
          var y = this.$utils().u;
          if (y(n)) return this.$u ? 0 : y(this.$offset) ? j.call(this) : this.$offset;
          ...
          var m = Math.abs(n) <= 16 ? 60 * n : n;
          if (m === 0) return this.utc(l);
          var _ = this.clone();
          if (l) return _.$offset = m, _.$u = !1, _;
          var v = this.$u ? this.toDate().getTimezoneOffset() : -1 * this.utcOffset();
          return (_ = this.local().add(m + v, r)).$offset = m, _.$x.$localOffset = v, _;
        };
        var u = d.format;
        d.format = function(n) {
        ...
        d.diff = function(n, l, y) {
          ...
          var m = this.local(), _ = $(n).local();
          return a.call(m, _, l, y);
        };
      };
    }));
  })(U)), U.exports;
